...
class BrewingType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
            ...
            //     'class'    => 'BrewBloggerCoreBundle:Styles',
            // ));
            ...
            $builder->add('waterProfile', 'entity', array(
                'class'    => 'BrewBloggerCoreBundle:WaterProfiles',
                'property' => 'name',
                'label'    => 'Water Profile',
                'attr'     => array(
                    'class' => 'input-xlarge'
            ...
            $builder->add('mashProfile', 'entity', array(
                'class'    => 'BrewBloggerCoreBundle:MashProfiles',
                'property' => 'name',
                'label'    => 'Mash Profile',
                'attr'     => array(
                    'class' => 'input-xxlarge'
            ...
            $builder->add('yeastProfile', 'entity', array(
                'class'    => 'BrewBloggerCoreBundle:YeastProfiles',
                'label'    => 'Yeast Name',
                'attr'     => array(
                    'class' => 'input-xxlarge'
                ),
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'BrewBlogger\CoreBundle\Entity\Brewing'
        ));
    }
