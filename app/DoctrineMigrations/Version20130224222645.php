...
/**
 * This loads the database from BrewBlogger 2.3.3, which is the baseline for 
 * development.
 */
class Version20130224222645 extends AbstractMigration
{
...
CREATE TABLE IF NOT EXISTS `adjuncts` (
  ...
  `adjunctInfo` text,
  `adjunctPPG` decimal(5,2) unsigned NOT NULL default '0.00',
  `adjunctLovibondLow` decimal(5,2) unsigned NOT NULL default '0.00',
  `adjunctLovibondHigh` decimal(5,2) unsigned NOT NULL default '0.00',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=63 ;
EOSQL
    );
        $this->addSql(<<<EOSQL
INSERT INTO `adjuncts` (`id`, `adjunctName`, `adjunctOrigin`, `adjunctSupplier`, `adjunctInfo`, `adjunctPPG`, `adjunctLovibondLow`, `adjunctLovibondHigh`) VALUES
(1, 'Flaked Barley', NULL, NULL, '<p>Helps head retention, imparts creamy smoothness. For porters and stouts.</p>', 32.00, 1.60, 0.00),
(2, 'Flaked Corn', NULL, NULL, 'Lightens body and color. For light American pilsners and ales.', 39.00, 1.00, 0.00),
(3, 'Flaked Oats', NULL, NULL, 'Adds body and creamy head. For stouts and oat ales.', 32.00, 1.00, 0.00),
(4, 'Flaked Rye', NULL, NULL, 'Imparts a dry, crisp character. Use in rye beers.', 32.00, 2.00, 0.00),
(5, 'Flaked Wheat', NULL, NULL, 'Imparts a wheat flavor and hazy color. For wheat beers and Belgian white beers.', 36.00, 2.00, 0.00),
(6, 'Grits', NULL, NULL, 'Imparts a corn/grain taste. Use in American lagers.', 37.00, 1.00, 0.00),
(7, 'Oats (Steel Cut)', NULL, NULL, 'Imparts oatmeal flavor for stouts.', 32.00, 10.00, 0.00),
(8, 'Flaked Rice', NULL, NULL, 'Imparts a light, crisp finish.', 38.00, 1.00, 0.00),
(9, 'Rice Hulls', NULL, NULL, 'Used as a filtering bed after mashing.', 38.00, 1.00, 0.00),
(10, 'Honey', NULL, NULL, NULL, 46.00, 1.00, 0.00),
(11, 'Sucrose (Table Sugar)', NULL, NULL, NULL, 37.00, 0.00, 0.00),
(14, 'Molasses', NULL, NULL, NULL, 46.00, 45.00, 0.00),
(16, 'Maple Syrup (Light)', NULL, NULL, NULL, 46.00, 20.00, 0.00),
(17, 'Maple Syrup (Dark)', NULL, NULL, NULL, 46.00, 45.00, 0.00),
(18, 'Raw Barley', NULL, NULL, 'Raw, unmalted barley can be used to add body to your beer. Use in homebrew requires very fine milling combined with a decoction or multi-stage mash. Performs best when used in small quantities with well modified grains.', 28.00, 2.00, 0.00),
(19, 'Torrified Wheat', NULL, NULL, 'Raw wheat that has been "popped" open to open kernels. Used in place of raw barley for faster conversion and higher yields. High in haze producing protein. ', 36.00, 1.70, 0.00),
(20, 'Brown Sugar, Dark', NULL, NULL, 'Imparts a rich sweet flavor. Used in Scottish ales, holiday ales and some old ales.', 46.00, 50.00, 0.00),
(21, 'Brown Sugar, Light', NULL, NULL, 'Used in Scottish ales, holiday ales and some old ales.', 46.00, 8.00, 0.00),
(22, 'Candi Sugar, Amber', NULL, NULL, 'Crystalized Candi Sugar (Sucrose) used in many Belgian Tripels, Dubbels, and holiday ales. Adds head retention and sweet aroma to beer. Adds color.', 36.00, 75.00, 0.00),
(23, 'Candi Sugar, Clear', NULL, NULL, 'Crystalized Candi Sugar (Sucrose) used in many Belgian Tripels, Dubbels, and holiday ales. Adds head retention and sweet aroma to beer.', 36.00, 0.50, 0.00),
(24, 'Candi Sugar, Dark', NULL, NULL, 'Crystalized Candi Sugar (Sucrose) used in many Belgian Tripels, Dubbels, and holiday ales. Adds head retention and sweet aroma to beer. Adds color.', 36.00, 275.00, 0.00),
(25, 'Beet Sugar', NULL, NULL, 'Common household baking sugar. Lightens flavor and body of beer. Can contribute a cider-like flavor to the beer if not cold-fermented or used in large quantities.', 46.00, 0.00, 0.00),
(26, 'Dextrose (Corn Sugar)', NULL, NULL, 'Increases gravity without adding much body. Commonly used for priming in bottles.', 46.00, 0.00, 0.00),
(27, 'Corn Syrup', NULL, NULL, 'Syrup derived from corn with many of the same properties as corn sugar. May be used to enhance gravity without adding much body or flavor. Limit percentage in batch to avoid wine or cider flavors. ', 46.00, 1.00, 0.00),
(28, 'Dememera Sugar', NULL, NULL, '<p>Unrefined dark sugar. Contains molasses.</p>', 46.00, 2.00, 0.00),
(29, 'Lactose (Milk Sugar)', NULL, NULL, 'Not fully fermentable, so it adds lasting sweetness. Lactose can be added to lend sweetness to Sweet Stouts and Porters.', 43.00, 0.00, 0.00),
(30, 'Molasses', NULL, NULL, 'mparts a strong, sweet flavor. Used primarily in stouts and porters. ', 46.00, 80.00, 0.00),
(31, 'Turinado Sugar', NULL, NULL, 'Light, raw brown sugar. May be used in British pale ales or high gravity Belgian ales. Limit percentage used to avoid undesirable flavors. Similar to Demerara sugar.', 46.00, 10.00, 0.00),
(32, 'Fruit - Blackberries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(33, 'Fruit - Raspberries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(34, 'Fruit - Marionberries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(35, 'Fruit - Blueberries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(36, 'Fruit - Cherries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(37, 'Fruit - Cranberries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(38, 'Fruit - Strawberries, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(39, 'Fruit - Watermellon, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(40, 'Fruit - Apples, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(41, 'Fruit - Grapes, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(42, 'Fruit - Peaches, Raw or Frozen', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(43, 'Fruit - Blackberries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(44, 'Fruit - Raspberries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(45, 'Fruit - Marionberries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(46, 'Fruit - Blueberries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(47, 'Fruit - Cherries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(48, 'Fruit - Cranberries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(49, 'Fruit - Strawberries, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(50, 'Fruit - Watermellon, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(51, 'Fruit - Apples, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(52, 'Fruit - Raisins', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(53, 'Fruit - Peaches, Dried', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(54, 'Fruit - Prunes', NULL, NULL, NULL, 38.00, 0.00, 0.00),
(55, 'Juice - Apple', NULL, NULL, NULL, 11.00, 0.00, 0.00),
(56, 'Juice - Grape', NULL, NULL, NULL, 14.00, 0.00, 0.00),
(57, 'Juice - Orange', NULL, NULL, NULL, 11.00, 0.00, 0.00),
(58, 'Juice - Pineapple', NULL, NULL, NULL, 12.00, 0.00, 0.00),
(59, 'Juice - Lemon', NULL, NULL, NULL, 3.00, 0.00, 0.00),
(60, 'Juice - Grapefruit', NULL, NULL, NULL, 6.00, 0.00, 0.00),
(61, 'Juice - Cranberry', NULL, NULL, NULL, 13.00, 0.00, 0.00),
(62, 'Juice - Other', NULL, NULL, NULL, 11.00, 0.00, 0.00);");
EOSQL
        );
...
CREATE TABLE IF NOT EXISTS `extract` (
  ...
  `extractInfo` text,
  `extractPPG` decimal(5,2) unsigned NOT NULL default '0.00',
  `extractOrigin` varchar(100) default NULL,
  `extractSupplier` varchar(100) default NULL,
  `extractLME` tinyint(1) NOT NULL default '0',
  `extractLovibondLow` decimal(5,2) unsigned NOT NULL default '0.00',
  `extractLovibondHigh` decimal(5,2) unsigned NOT NULL default '0.00',
  PRIMARY KEY  (`id`)
...
EOSQL
        ...
        $this->addSql(<<<EOSQL
INSERT INTO `extract` (`id`, `extractName`, `extractInfo`, `extractPPG`, `extractOrigin`, `extractSupplier`, `extractLME`, `extractLovibondLow`, `extractLovibondHigh`) VALUES
(1, 'DME - Extra Light', NULL, 44.00, NULL, NULL, 0, 3.00, 0.00),
(2, 'DME - Light', NULL, 44.00, NULL, NULL, 0, 3.50, 0.00),
(3, 'DME - Amber', NULL, 44.00, NULL, NULL, 0, 10.00, 0.00),
(4, 'DME - Dark', NULL, 44.00, NULL, NULL, 0, 30.00, 0.00),
(5, 'LME - Extra Light', NULL, 37.00, NULL, NULL, 1, 1.00, 0.00),
(6, 'LME - Light', NULL, 37.00, NULL, NULL, 1, 3.50, 0.00),
(7, 'LME - Amber', NULL, 37.00, NULL, NULL, 1, 10.00, 0.00),
(8, 'LME - Dark', NULL, 37.00, NULL, NULL, 1, 30.00, 0.00),
(9, 'LME - Munich', NULL, 37.00, NULL, NULL, 1, 10.00, 0.00),
(10, 'LME - Pilsner', NULL, 37.00, NULL, NULL, 1, 6.00, 0.00),
(11, 'LME - Wheat', NULL, 37.00, NULL, NULL, 1, 6.00, 0.00);
EOSQL
        );
        $this->addSql(<<<EOSQL
CREATE TABLE IF NOT EXISTS `malt` (
  ...
  `maltOrigin` varchar(100) default NULL,
  `maltSupplier` varchar(100) default NULL,
  `maltLovibondLow` decimal(5,2) unsigned NOT NULL default '0.00',
  `maltLovibondHigh` decimal(5,2) unsigned NOT NULL default '0.00',
  PRIMARY KEY  (`id`)
...
EOSQL
        ...
        $this->addSql(<<<EOSQL
INSERT INTO `malt` (`id`, `maltName`, `maltInfo`, `maltPPG`, `maltOrigin`, `maltSupplier`, `maltLovibondLow`, `maltLovibondHigh`) VALUES
(1, 'Crystal Malt 10L', 'Sweet, mild caramel flavor and a golden color. Use in light lagers and light ales.', 35.00, NULL, NULL, 10.00, 0.00),
(2, 'Crystal Malt 20L', 'Sweet, mild caramel flavor and a golden color. Use in light lagers and light ales.', 35.00, NULL, NULL, 20.00, 0.00),
(3, 'Crystal Malt 30L', 'Sweet, mild caramel flavor and a golden color. Use in light lagers and light ales.', 34.00, NULL, NULL, 30.00, 0.00),
(4, 'Crystal Malt 40L', 'Sweet, mild caramel flavor and a golden color. Use in light lagers and light ales.', 34.00, NULL, NULL, 40.00, 0.00),
(5, 'Crystal Malt 60L', 'Sweet, mild caramel flavor and a golden color. Use in amber and brown ales.', 34.00, NULL, NULL, 60.00, 0.00),
(6, 'Crystal Malt 80L', 'Sweet, mild caramel flavor and a golden color. For porters and stouts', 33.00, NULL, NULL, 80.00, 0.00),
(7, 'Crystal Malt 90L', 'Pronounced caramel flavor and a red color. For stouts, porters and black beers.', 33.00, NULL, NULL, 90.00, 0.00),
(8, 'Crystal Malt 120L', 'Pronounced caramel flavor and a red color. For stouts, porters and black beers.', 33.00, NULL, NULL, 120.00, 0.00),
(9, 'American Black Patent', 'Provides color and sharp flavor. Use in stouts and porters.', 25.00, NULL, NULL, 127.00, 0.00),
(10, 'American Roasted Barley', 'Sweet, grainy, coffee flavor and a red to deep brown color.', 25.00, NULL, NULL, 127.00, 0.00),
(11, 'American Black Barley', '<p>Provides dryness.</p>', 25.00, NULL, NULL, 127.00, 0.00),
(12, 'American Chocolate Malt', 'Use in all types to adjust color and add nutty, toasted flavor. Chocolate flavor.', 28.00, NULL, NULL, 127.00, 0.00),
(13, 'American Dextrin (Cara-Pils) Malt', 'Balances body and flavor without adding color, aids in head retention. For any beer.', 32.00, NULL, NULL, 1.00, 0.00),
(14, 'American Pale Malt (2-Row)', 'Smooth, less grainy, moderate malt flavor. Basic malt for all beer styles.', 35.00, NULL, NULL, 1.00, 0.00),
(15, 'American Munich Malt', 'Sweet, toasted flavor and aroma. For Oktoberfests and malty styles.', 35.00, NULL, NULL, 10.00, 0.00),
(16, 'American Special Roast', 'Provides a deep golden to brown color for ales. Use in all darker ales.', 32.00, NULL, NULL, 50.00, 0.00),
(17, 'American Vienna Malt', 'Increases malty flavor, provides balance. Use in Vienna, Marzen and Oktoberfest.', 35.00, NULL, NULL, 4.00, 0.00),
(19, 'American Victory Malt', 'Provides a deep golden to brown color. Use in nut brown ales, IPAs and Scottish ales.', 34.00, NULL, NULL, 25.00, 0.00),
(20, 'American Pale Malt (6-Row)', 'Moderate malt flavor. Basic malt for all beer styles.', 35.00, NULL, NULL, 1.00, 0.00),
(21, 'American Wheat Malt', 'Light flavor and creamy head. For American weizenbier, weissbier and dunkelweiss.', 37.00, NULL, NULL, 2.00, 0.00),
(22, 'American White Wheat Malt', 'Imparts a malty flavor. For American wheat beers, wheat bock and doppel bock.', 29.00, NULL, NULL, 2.00, 0.00),
(23, 'Belgian Aromatic Malt', 'Imparts a big malt aroma. Use in brown ales, Belgian dubbels and tripels.', 34.00, NULL, NULL, 20.00, 0.00),
(24, 'Belgian Biscuit Malt', 'Warm baked biscuit flavor and aroma. Increases body. Use in Belgian beers.', 35.00, NULL, NULL, 23.00, 0.00),
(26, 'Belgian Caravienne Malt', 'Light crystal malt. Used in lighter Abbey or Trappist style ales.', 34.00, NULL, NULL, 21.00, 0.00),
(27, 'Belgian Pale Ale Malt', 'Use as a base malt for any Belgian style beer with full body.', 38.00, NULL, NULL, 2.70, 0.00),
(28, 'Belgian Plisen Malt', 'Light color, malty flavor. For pilsners, dubbels, tripels, whites and specialty ales.', 36.00, NULL, NULL, 1.50, 0.00),
(29, 'Belgian Special B Malt', 'Extreme caramel aroma and flavor. For dark Abbey beers and other dark beers.', 31.00, NULL, NULL, 130.00, 0.00),
(30, 'British Amber Malt', 'Roasted malt used in British milds, old ales, brown ales, nut brown ales.', 35.00, NULL, NULL, 35.00, 0.00),
(31, 'British Brown Malt', 'Imparts a dry, biscuit flavor. Use in porters, brown, nut brown and Belgian ales.', 32.00, NULL, NULL, 65.00, 0.00),
(32, 'British Maris Otter Pale Malt', 'Premium base malt for any beer. Good for pale ales. ', 38.00, NULL, NULL, 3.00, 0.00),
(33, 'British Pale Ale Malt', 'Moderate malt flavor. Used to produce traditional English and Scottish style ales. ', 38.00, NULL, NULL, 2.20, 0.00),
(34, 'British Crystal Malt', 'Sweet caramel flavor, adds mouthfeel and head retention. For pale or amber ales. ', 34.00, NULL, NULL, 55.00, 0.00),
(35, 'British Dark Crystal Malt', 'Sweet caramel flavor, mouthfeel. For porters, stouts, old ales and any dark ale.', 33.00, NULL, NULL, 145.00, 0.00),
(36, 'British Mild Ale Malt', 'Dry, nutty malty flavor. Promotes body. Use in English mild ales.', 37.00, NULL, NULL, 2.30, 0.00),
(37, 'British Dextrin (Cara-Pils) Malt', 'Adds body; aids head retention. For porters, stouts and heavier bodied beers.', 32.00, NULL, NULL, 10.00, 0.00),
(38, 'British Chocolate Malt', 'Nutty, toasted flavor, brown color. Use as a specialty grain in brown ales, porters, stouts and bocks.', 28.00, NULL, NULL, 395.00, 0.00),
(39, 'British Black Patent Malt', 'Dry, burnt, chalky character. Use in porters, stouts, brown ales and dark lagers.', 25.00, NULL, NULL, 500.00, 0.00),
(40, 'British Peat Smoked Malt', 'Imparts a robust smoky flavor and aroma. For Scottish ales and wee heavies.', 34.00, NULL, NULL, 2.80, 0.00),
(41, 'British Roasted Barley', 'Dry, roasted flavor, amber color. For stouts, porters and Scottish ales.', 25.00, NULL, NULL, 500.00, 0.00),
(42, 'British Toasted Pale Malt', 'Imparts nutty flavor and aroma. Use in IPAs and Scottish ales.', 29.00, NULL, NULL, 25.00, 0.00),
(43, 'British Wheat Malt', 'Light flavor, creamy head. For wheat beers, stouts, doppelbocks and alt beers. ', 37.00, NULL, NULL, 2.00, 0.00),
(44, 'British Torrified Wheat', 'Puffed wheat created by high heat. Use in pale ales, bitters and milds.', 36.00, NULL, NULL, 1.00, 0.00),
(45, 'German Acidulated (Sauer) Malt', 'High lactic acid. For lambics, sour mash beers, Irish stout, pilsners and wheats. ', 38.00, NULL, NULL, 1.70, 0.00),
(46, 'German Carafa I', 'Gives deep aroma and color to dark beers, bocks, stout, alt and schwarzbier. ', 32.00, NULL, NULL, 300.00, 0.00),
(47, 'German Carafa II', 'Adds aroma, color and body.', 32.00, NULL, NULL, 375.00, 0.00),
(48, 'German Carafa III', 'Adds aroma, color and body.', 32.00, NULL, NULL, 490.00, 0.00),
(49, 'German Chocolate Wheat Malt', 'Intensifies aroma; improves color. For dark ales, alt, dark wheat, stout and porter.', 33.00, NULL, NULL, 375.00, 0.00),
(50, 'German Chocolate Rye Malt', 'Enhances aroma of dark ales and improves color. For dunkel rye wheat and ale.', 31.00, NULL, NULL, 190.00, 0.00),
(51, 'German CaraHell (Light Crystal) Malt', 'For light colored beer for body; hefeweizen, pale ale, golden ale, Oktoberfest.', 35.00, NULL, NULL, 8.00, 0.00),
(52, 'German CaraMunich Malt I', 'Provides body. For Oktoberfest, bock, porter, stout, red, amber and brown ales. Results include increased fullness, heightened aroma and fuller flavor. Use 1 - 5% for light or pale beers.', 33.00, NULL, NULL, 30.00, 0.00),
(53, 'German CaraMunich Malt II', 'Provides body. For Oktoberfest, bock, porter, stout, red, amber and brown ales. Results in increased fullness, heightened aroma, fuller flavor and deep color. Use 5 -10% for darker beers. ', 33.00, NULL, NULL, 42.00, 0.00),
(54, 'German CaraMunich Malt III', 'Provides body. For Oktoberfest, bock, porter, stout, red, amber and brown ales. Dark crystal. Results in deep saturated color and a fuller flavor.', 33.00, NULL, NULL, 53.00, 0.00),
(55, 'German Light Munich Malt', 'For a malty, nutty flavor. Lagers, Oktoberfests and bock beer. ', 35.00, NULL, NULL, 5.00, 0.00),
(56, 'German Dark Munich Malt', 'Enhances body and aroma. Stout, schwarzbier, brown ale, dark and amber ales.', 35.00, NULL, NULL, 8.00, 0.00),
(57, 'German Melanoidin Malt', 'For amber lagers and ales, dark lagers and ales, Scottish &amp; red ales. Imparts a reddish hue.', 37.00, NULL, NULL, 23.00, 0.00),
(58, 'German Rauch Smoked Malt', 'For rauchbier, kellerbier, smoked porters, Scottish ales and barleywines.', 37.00, NULL, NULL, 2.00, 0.00),
(59, 'German Rye Malt', 'Dry character. Can use as a base malt. For seasonal beers, roggenbier and ales. ', 29.00, NULL, NULL, 2.80, 0.00),
(60, 'German Wheat Malt Light', 'Typical top fermented aroma; for wheat beers.', 39.00, NULL, NULL, 1.50, 0.00),
(61, 'German Wheat Malt Dark', 'Typical top fermented aroma; for wheat beers.', 39.00, NULL, NULL, 6.00, 0.00),
(62, 'German Caramel Wheat Malt', 'For dark ales, hefeweizen, dunkelweizen, wheat bocks and double bocks.', 35.00, NULL, NULL, 38.00, 0.00),
(63, 'British Carastan Malt', 'A British malt similar to American or Belgian crystal malts.', 34.00, NULL, NULL, 30.00, 0.00),
(64, 'Honey Malt', 'Malt sweetness and honey like flavor and aroma.', 37.00, NULL, NULL, 25.00, 0.00),
(65, 'Scottish Golden Promise', 'Scottish pale ale malt; base malt for all Scottish beers.', 38.00, NULL, NULL, 2.40, 0.00),
(66, 'Flaked Barley', 'Helps head retention, imparts creamy smoothness. For porters and stouts.', 32.00, NULL, NULL, 1.50, 0.00),
(67, 'Flaked Maize', 'Lightens body and color. For light American pilsners and ales.', 39.00, NULL, NULL, 1.00, 0.00),
(68, 'Flaked Oats', 'Adds body and creamy head. For stouts and oat ales.', 32.00, NULL, NULL, 1.00, 0.00),
(69, 'Flaked Rye', 'Imparts a dry, crisp character. Use in rye beers.', 29.00, NULL, NULL, 2.00, 0.00),
(70, 'Flaked Wheat', 'Imparts a wheat flavor and hazy color. For wheat beers and Belgian white beers.', 32.00, NULL, NULL, 2.00, 0.00),
(71, 'Grits', 'Imparts a corn/grain taste. Use in American lagers.', 37.00, NULL, NULL, 1.00, 0.00),
(72, 'German Vienna Malt', 'Increases malty flavor, provides balance. Use in Vienna, Marzen and Oktoberfest.', 35.00, NULL, NULL, 3.00, 0.00),
(73, 'Scottish Peated Malt', 'Imparts a smoky flavor.', 34.00, NULL, NULL, 3.00, 0.00),
(74, 'Oats (Steel Cut)', 'Imparts oatmeal flavor for stouts.', 32.00, NULL, NULL, 10.00, 0.00),
(75, 'Flaked Rice', 'Imparts a light, crisp finish.', 38.00, NULL, NULL, 1.00, 0.00),
(76, 'Rice Hulls', 'Used as a filtering bed after mashing.', 38.00, NULL, NULL, 1.00, 0.00),
(77, 'German Carafa I De-Husked Malt', 'De-husked for a less bitter taste. Great for use in Dark beers, Stouts, Altbier, and Bockbier. The unique de-husked barley adds aroma, color and body, with a milder smoother flavor that can be achieved with whole grains.', 32.00, NULL, NULL, 400.00, 0.00),
(78, 'German Carafa II De-Husked Malt', 'De-husked for a less bitter taste. Great for use in Dark beers, Stouts, Altbier, and Bockbier. The unique de-husked barley adds aroma, color and body, with a milder smoother flavor that can be achieved with whole grains.', 32.00, NULL, NULL, 500.00, 0.00),
(79, 'German Carafa III De-Husked Malt', 'De-husked for a less bitter taste. Great for use in Dark beers, Stouts, Altbier, and Bockbier. The unique de-husked barley adds aroma, color and body, with a milder smoother flavor that can be achieved with whole grains.', 32.00, NULL, NULL, 650.00, 0.00),
(81, 'German Wheat Chocolate Malt', 'A roasted wheat malt used Altbier or Dark Wheat Beer (Ales). It results in an intensified aroma and improved color and a mild roasted flavor.', 33.00, NULL, NULL, 500.00, 0.00),
(82, 'Belgian Munich Malt', 'Used to increase malt aroma and body with slightly more color. ', 35.00, NULL, NULL, 3.00, 0.00),
(83, 'German Pilsen Malt (2-Row)', 'Light color, malty flavor. For pilsners, lagers.', 36.00, NULL, NULL, 1.50, 0.00),
(84, 'American Pilsen Malt', 'Light color, malty flavor. For pilsners, lagers.', 36.00, NULL, NULL, 1.00, 0.00),
(85, 'American Rye Malt', NULL, 29.00, NULL, NULL, 3.70, 0.00),
(86, 'British Pale Chocolate', 'Used in darker beers such as porters and stouts to add color and richness. It is used in preference to chocolate malt when less color from the grains is desired and a grain with milder flavors is needed.', 31.00, 'United Kingdom', 'Thomas Fawcett and Sons', 200.00, 0.00);
EOSQL
        );
...
CREATE TABLE IF NOT EXISTS `brewing` (
  ...
  `brewHops10IBU` varchar(10) default NULL,
  ...
  `brewHops11IBU` varchar(10) default NULL,
  ...
  `brewHops12IBU` varchar(10) default NULL,
  ...
  `brewHops13IBU` varchar(10) default NULL,
  ...
  `brewHops14IBU` varchar(10) default NULL,
  ...
  `brewHops15IBU` varchar(10) default NULL,
...
(15, 'SB12.css', 'SB12', '#dae2ec', '#c7d3e3');
EOSQL
        );
...
CREATE TABLE IF NOT EXISTS `styles` (
  `id` tinyint(4) NOT NULL auto_increment,
  `brewStyleNum` char(3) character set utf8 default NULL,
  `brewStyle` varchar(250) character set utf8 default NULL,
  `brewStyleOG` varchar(20) character set utf8 default NULL,
  `brewStyleOGMax` varchar(25) character set utf8 default NULL,
  `brewStyleFG` varchar(20) character set utf8 default NULL,
  `brewStyleFGMax` varchar(25) character set utf8 default NULL,
  `brewStyleABV` varchar(250) character set utf8 default NULL,
  `brewStyleABVMax` varchar(25) character set utf8 default NULL,
  `brewStyleIBU` varchar(250) character set utf8 default NULL,
  `brewStyleIBUMax` varchar(25) character set utf8 default NULL,
  `brewStyleSRM` varchar(250) character set utf8 default NULL,
  `brewStyleSRMMax` varchar(25) character set utf8 default NULL,
  `brewStyleType` varchar(25) character set utf8 default NULL,
  `brewStyleInfo` text character set utf8,
  `brewStyleLink` varchar(200) character set utf8 default NULL,
  `brewStyleGroup` char(2) character set utf8 default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM;
EOSQL
        );
...
EOSQL
    ...
    {
        $this->addSql('DROP TABLE `adjuncts');
        $this->addSql('DROP TABLE `extract');
        $this->addSql('DROP TABLE `malt');
        $this->addSql('DROP TABLE `brewing');
        $this->addSql('DROP TABLE `brewingcss');
        $this->addSql('DROP TABLE `preferences');
        $this->addSql('DROP TABLE `recipes');
        $this->addSql('DROP TABLE `awards');
        $this->addSql('DROP TABLE `brewer');
        $this->addSql('DROP TABLE `brewerlinks');
        $this->addSql('DROP TABLE `equip_profiles');
        $this->addSql('DROP TABLE `hops');
        $this->addSql('DROP TABLE `mash_profiles');
        $this->addSql('DROP TABLE `mash_steps');
        ...
        $this->addSql('DROP TABLE `water_profiles');
        $this->addSql('DROP TABLE `yeast_profiles');
    }
}
